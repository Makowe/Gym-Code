...
Routine routineDismountInGroupThree = Routine(
    apparatus: Apparatus.floor, elements: [f_1_1, f_2_1, f_3_1]);

// The last element belongs to group 1, so the routine has no dismount.
Routine routineLastElementGroupOne = Routine(
    apparatus: Apparatus.floor, elements: [f_2_1, f_3_1, f_1_1]);

// f_2_7 is a "no dismount" element even though it is group 2.
Routine routineLastElementIsNoDismountId = Routine(
    apparatus: Apparatus.floor, elements: [f_1_1, f_3_1, f_2_7]);
...
Routine routineEarlierElementRepeatsDismount = Routine(
    apparatus: Apparatus.floor, elements: [f_1_1, f_3_1, f_2_1, f_3_1]);
...
Routine routineWithGroupFourNonDismount = Routine(
    apparatus: Apparatus.floor,
    elements: [f_1_1, f_2_1, f_4_2, f_3_1]);
